...
if(NOT NFX_DATATYPES_PACKAGE_SOURCE
		AND NOT NFX_DATATYPES_PACKAGE_ARCHIVE
		AND NOT NFX_DATATYPES_PACKAGE_DEB
		AND NOT NFX_DATATYPES_PACKAGE_RPM
		AND NOT NFX_DATATYPES_PACKAGE_WIX)
...
if(NFX_DATATYPES_PACKAGE_SOURCE)
...
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY  "nfx-datatypes")
...
if(NOT DEFINED CPACK_GENERATOR)
	...
	# --- Archive packages ---
	if(NFX_DATATYPES_PACKAGE_ARCHIVE)
		if(UNIX AND NOT APPLE)
	...
	# --- DEB packages ---
	if(NFX_DATATYPES_PACKAGE_DEB AND UNIX AND NOT APPLE)
		if(DPKG_CMD)
	...
	# --- RPM packages ---
	if(NFX_DATATYPES_PACKAGE_RPM AND UNIX AND NOT APPLE)
		if(RPM_CMD)
...
if("RPM" IN_LIST CPACK_GENERATOR AND UNIX AND NOT APPLE)
	...
	set(CPACK_RPM_PACKAGE_LICENSE       ${NFX_DATATYPES_LICENSE})
